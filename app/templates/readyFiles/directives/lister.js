(function () {
    ...
    function lister($timeout, $compile, $templateRequest, $templateCache, DTOptionsBuilder, DTColumnDefBuilder, DTColumnBuilder) {
            ...
            link: {
                pre: function(scope) {
                    ...
                    var columns = [
                        ...
                        { field: 'accessLevel', title: 'Access Level',
                            hasFilter: {
                                type: 'select',
                                label: 'Access level',
                                values: ['All', 'Builder', 'Manager', 'Client', 'Buyer']
                            }
                        },
                    ...
                    function fetchData(data, callback, settings) {
                        ...
                        normQuery.start = data.start;
                        normQuery.length = data.length;
                        normQuery.order = data.order;
